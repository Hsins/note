...
## 065, Section 5 Introduction

這一單元主要講解 MySQL 中的 CRUD 操作。

## 066, Introduction to CRUD
...
## 068, Preparing Our Data

首先要刪除原有的資料表並創建這一節需要的資料表，詳見下一則筆記。

## 069, CODE: Preparing Our Data
...
## 070, Official Introduction to SELECT
...
## 071, CODE: Official Introduction to SELECT
...
## 073, CODE: Introduction to WHERE
...
## 075, SELECT Challenges Solution

詳見下一則筆記。

## 076, CODE: SELECT Challenges Solution
...
## 078, CODE: Introduction to Aliases
...
## 085, CODE: Introduction to DELETE
...
## 086, DELETE Challenges

1. DELETE all 4 year old cats
2. DELETE cats whose age is the same as their cat_id
3. DELETE all cats

## 087, DELETE Challenges Solution

詳見下一則筆記。

## 088, CODE: DELETE Challenges Solution
