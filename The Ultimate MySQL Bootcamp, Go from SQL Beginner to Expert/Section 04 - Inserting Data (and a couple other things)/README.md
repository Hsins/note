...
## 046, Super Quick Intro To SELECT

在後續的課程中我們將會學到可以使用 `SELECT * FROM <tablename>;` 來取得指定資料表中的資料。

## 047, CODE: Super Quick Intro To SELECT
...
## 051, INSERT Challenges Solution

略，見下一則筆記。

## 052, CODE: INSERT Challenges Solution
...
## 059, CODE: Setting Default Values
...
## 061, CODE: A Primer on Primary Keys
...
## 062, Table Constraints Exercise
...
## 063, Table Constraints Exercise Solution

詳見下一則筆記。

## 064, CODE: Table Constraints Exercise Solution
