...
- [Section 27 - Working With API's](#section-27---working-with-apis)
  - [Table of Contents](#table-of-contents)
  - [[Lecture] Intro to API's](#lecture-intro-to-apis)
  - [[Lecture] JSON and XML](#lecture-json-and-xml)
    - [XML](#xml)
    - [JSON](#json)
  - [[Lecture] Making API Requests with Node](#lecture-making-api-requests-with-node)
    - [Send Request with Command Line](#send-request-with-command-line)
    - [Send Request with Node.js](#send-request-with-nodejs)
  - [[Lecture] Sunset Time API Example](#lecture-sunset-time-api-example)
  - [[Lecture] JSON Placeholder API Example](#lecture-json-placeholder-api-example)
  - [[Lecture] Note about Movie API lectures](#lecture-note-about-movie-api-lectures)
  - [[Lecture] Movie API App: Introduction](#lecture-movie-api-app-introduction)
  - [[Lecture] Movie API App: Results Route](#lecture-movie-api-app-results-route)
  - [[Lecture] Movie API App: Displaying Data](#lecture-movie-api-app-displaying-data)
  - [[Lecture] Movie API App: Adding Search](#lecture-movie-api-app-adding-search)

## [Lecture] Intro to API's
...
## [Lecture] Making API Requests with Node
...
## [Lecture] Sunset Time API Example
...
## [Lecture] JSON Placeholder API Example
...
## [Lecture] Note about Movie API lectures
...
## [Lecture] Movie API App: Introduction
...
## [Lecture] Movie API App: Results Route
...
## [Lecture] Movie API App: Displaying Data
...
## [Lecture] Movie API App: Adding Search
